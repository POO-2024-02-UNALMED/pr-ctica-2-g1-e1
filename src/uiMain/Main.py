...
class VentanaInicio(tk.Tk):
    ...
    def mostrar_descripcion(self):
        messagebox.showinfo("Descripción", "Esta es una aplicación para gestionar el sistema basado en la práctica 1.")
    ...
    def crear_estructura(self):
        ...
        btn_ingresar = tk.Button(p4, text="Ingresar", command=self.abrir_ventana_principal)
        ...
        hoja_vida = tk.Label(p5, text="Aquí se mostrará la hoja de vida de los desarrolladores", wraplength=300, justify="left")
        ...
        for i in range(2):
            for j in range(2):
                tk.Label(p6, text=f"Foto {i*2+j+1}", bg="white", relief="solid").grid(row=i, column=j, padx=5, pady=5, sticky="nsew")
